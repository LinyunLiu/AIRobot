...
class RightWheel(Node):
    def __init__(self):
        ...
        self.get_logger().info('RightWheel Listening')
        ...
        self.U = gpiozero.DigitalInputDevice(17)
        self.V = gpiozero.DigitalInputDevice(27)
        self.W = gpiozero.DigitalInputDevice(22)
    ...
    def u(self):
        ...
        # self.rpm_queue.append(self.rpm(self.pulse_time_avg))
        # self.RPM = sum(self.rpm_queue) / len(self.rpm_queue)
	#        self.RPM = self.rpm(self.pulse_time_avg)
