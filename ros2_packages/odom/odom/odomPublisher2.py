...
# Publish tf and odometry, linear from subscribed vel_L and vel_R of the wheels
#                          angular from subscribed imu

class OdometryPublisher(Node):
    def __init__(self):
        super().__init__('odom_publisher2')
        ...
        self.twistTimer = self.create_timer(0.001, self.setTwist)
    ...
    def imu_callback(self, msg):
        self.vth = self.degrees_to_radians(msg.angular_velocity.z)
        self.vth *= 55
    ...
    def setTwist(self):
        ...
        # self.vth = self.degrees_to_radians(self.mpu.gyro[2])
        # print(linear, self.vth, self.th)
        # print(round(self.leftVel, 3), round(self.rightVel,3))
