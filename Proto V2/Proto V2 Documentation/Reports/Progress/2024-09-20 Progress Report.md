...
## Details
- Dr Park introduced the screen and input devices for the RPI4, but there wasn't a way to connect the display to the RPI4. So Setting up remote desktop for RPI4 will be done next week either Monday or Wednesday at the earliest.
